...
To enable automatic scaffolding when compiling classes, add the following configuration line:

[source,groovy]
----
griffon.simplejpa.scaffolding.auto = true
----

Another scaffolding related configurations are:
