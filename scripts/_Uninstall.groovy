...
//
// check to see if we already have a SimpleJpaGriffonAddon
// def configText = '''root.'SimpleJpaGriffonAddon'.addon=true'''
// if(builderConfigFile.text.contains(configText)) {
//     println 'Removing SimpleJpaGriffonAddon from Builder.groovy'
